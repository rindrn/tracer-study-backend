 ...
 *
 * Business key id_kesesuaian_level = "{questionnaire_id}:f15:{option_code}",
 ...
 * (misal jadi 1-7) atau redaksi label f15, opsi itu otomatis MASUK
...
class KesesuaianLevelDimService
{
    ...
    public function sync(array $questionnaireIds): array
    {
        ...
        foreach (array_unique($questionnaireIds) as $questionnaireId) {
            ...
            foreach ($options as $opt) {
                ...
                $idKesesuaianLevel = $this->deriveBusinessKey($questionnaireId, $opt->option_code);
    ...
    /**
     * Resolve id_kesesuaian_level untuk satu jawaban f15 mentah, dipakai
     ...
     */
    public function resolveIdKesesuaianLevel(int $questionnaireId, string $rawOptionCode): string
    {
