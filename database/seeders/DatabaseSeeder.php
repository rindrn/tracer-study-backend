...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->ensureBulanSesudahLulusMapped();
    }

    /**
     * Mendaftarkan role "bulan_sesudah_lulus" (f303) dan memetakannya di
     * setiap questionnaire yang punya field itu.
     *
     * Logika ini sebelumnya HANYA ada di migration
     * 2026_08_06_000001_map_f303_to_bulan_sesudah_lulus, yang gagal pada
     * instalasi fresh karena migration jalan sebelum semantic_role_registry
     * & question_semantic_mapping diimpor lewat importOltpSupplement() di
     * atas. Migration itu sekarang no-op kalau tabelnya belum ada saat ia
     * jalan (lihat komentarnya), jadi langkah ini yang menjamin f303 tetap
     * terpetakan pada instalasi fresh. Idempoten: aman dipanggil berkali-kali.
     */
    private function ensureBulanSesudahLulusMapped(): void
    {
        $db = \Illuminate\Support\Facades\DB::connection('oltp');
